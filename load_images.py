...
def pickle_images_labels(update_id):
	images_labels = []
	...
	for image in images:
		...
		count += 1
		flip_images_progressbar = count / (len(images)) * 100
		update_id(flip_images_progressbar)
	return images_labels

def run_load_images(update_id):
	images_labels = pickle_images_labels(update_id)
