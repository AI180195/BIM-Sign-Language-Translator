...
def recognize():
	...
	while True:
		...
		if isinstance(text, tuple):
			...
			fontpath = "./font/simsun.ttc"  # <== 这里是宋体路径
			font = ImageFont.truetype(fontpath, 50)
			img_pil = Image.fromarray(blackboard)
			draw = ImageDraw.Draw(img_pil)
			draw.text((30, 270), "华文： "+text[4], font=font, fill=(255, 255, 255, 0))
			...
			draw2.text((30, 340), "தமிழ்: "+text[5], font=font2, fill=(255, 255, 255, 0))
